...
import com.example.chuyen_doi_activity.activity.detail_story_activity;
import com.example.chuyen_doi_activity.model.Story;
    ...
    public void onBindViewHolder(@NonNull StoryViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, detail_story_activity.class);
